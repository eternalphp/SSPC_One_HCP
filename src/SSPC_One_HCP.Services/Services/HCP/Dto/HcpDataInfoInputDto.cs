...
{
    public class HcpDataInfoInputDto
    {
        /// <summary>
        /// 知识库信息
        /// </summary>
        [DataMember]
        public HcpDataInfo dataInfo { get; set; }
        ...
        [DataMember]
        public HcpDataInfoBuDeptSelectionViewModel ProductAndDeps { get; set; }
    }
    ...
    [DataContract]
    [NotMapped]
    public class HcpDataInfoBuDeptSelectionViewModel
    {
        /// <summary>
        /// BU名称列表
        /// </summary>
