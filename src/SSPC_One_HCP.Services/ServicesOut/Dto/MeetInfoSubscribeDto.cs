...
namespace SSPC_One_HCP.ServicesOut.Dto
{
   public class MeetInfoSubscribeDto
    {
        /// <summary>
        /// 时间戳
        /// </summary>
    ...
    [NotMapped]
    [DataContract]
    public class MeetInfoViewDtoModel
    {
        /// <summary>
        /// 会议信息
        /// </summary>
        ...
        [DataMember]
        public IEnumerable<MeetQARelationViewModel> MeetQARelations { get; set; }
    }
}
