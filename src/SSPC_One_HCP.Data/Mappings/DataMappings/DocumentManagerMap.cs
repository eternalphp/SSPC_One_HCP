...
namespace SSPC_One_HCP.Data.Mappings.DataMappings
{
    ...
    public class DocumentManagerMap : BaseEntityTypeConfiguration<DocumentManager>
    {

        public DocumentManagerMap()
        {
            this.ToTable("DocumentManager");
            ...
            this.Property(t => t.IsDownload)
               .HasColumnName("Isdownload");
        }
    }
}
