...
using SSPC_One_HCP.Data.Mappings;
using System.Data;

namespace SSPC_One_HCP.Data.Data
{
    public class FacDbContext : DbContext, IDbContext
    {
        #region Ctor

        public FacDbContext()
        : base("Data Source=.;Initial Catalog=SSPC_One_HCP1;User Id = sa;pwd=sa;Integrated Security=false;")
        {

        }

        public FacDbContext(string nameOrConnectionString)
            : base(nameOrConnectionString)
        {
            //((IObjectContextAdapter) this).ObjectContext.ContextOptions.LazyLoadingEnabled = true;
        }

        public FacDbContext(DbConnection connection)
